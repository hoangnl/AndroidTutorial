...
public class MainActivity extends BaseActivity implements GetFlickrjsonData.OnDataAvaiable,
...
//        getRawData.execute("https://api.flickr.com/services/feeds/photos_public.gne?tags=android&tagmode=any&format=json&nojsoncallback=1");
    ...
    protected void onResume() {
        ...
        String queryResult = share.getString(FLICKR_QUERY, "");
    ...
    public void onItemClick(View view, int position) {
        ...
        Toast.makeText(MainActivity.this, "Normal tap in position: " + position, Toast.LENGTH_SHORT).show();
    }
